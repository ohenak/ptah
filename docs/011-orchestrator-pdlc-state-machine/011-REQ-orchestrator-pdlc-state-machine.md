...
| REQ-RT-04 | Approval detection from cross-review files | The orchestrator must detect approval or rejection by parsing the cross-review file for the **Recommendation** field. Matching must be case-insensitive and whitespace-tolerant. Values recognized: "approved" → `approved`, "approved with minor changes" → `approved`, "needs revision" → `revision_requested`. If the recommendation field cannot be parsed or is missing, the reviewer status remains `pending` and the orchestrator pauses the feature via `ROUTE_TO_USER` to alert the developer. | WHO: As the orchestrator GIVEN: a reviewer agent completes and a cross-review file is committed WHEN: the orchestrator reads the cross-review file THEN: the recommendation is correctly parsed (case-insensitive) and the reviewer's status is updated accordingly; if unparseable, the feature pauses and the developer is notified | P0 | 1 | [US-14], [US-16] | [REQ-RT-03] |
...
| Priority | Count | IDs |
|----------|-------|-----|
| P0 | 37 | REQ-SM-01, REQ-SM-02, REQ-SM-03, REQ-SM-05, REQ-SM-06, REQ-SM-07, REQ-SM-08, REQ-SM-09, REQ-SM-10, REQ-SM-11, REQ-RT-01, REQ-RT-02, REQ-RT-03, REQ-RT-04, REQ-RT-05, REQ-RT-06, REQ-RT-07, REQ-AI-01, REQ-AI-02, REQ-AI-03, REQ-AI-04, REQ-FC-01, REQ-FC-02, REQ-FC-04, REQ-FC-05, REQ-SA-01, REQ-SA-02, REQ-SA-03, REQ-SA-04, REQ-SA-05, REQ-SA-06, REQ-CA-01, REQ-CA-02, REQ-CA-03, REQ-SM-NF-02, REQ-SM-NF-03, REQ-SM-NF-04 |
...
| Phase | Count | IDs |
|-------|-------|-----|
| Phase 1 (all) | 43 | All requirements are Phase 1 — this feature is delivered as a single unit |
