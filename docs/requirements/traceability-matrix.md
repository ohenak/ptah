...
| 3.5 | April 10, 2026 | Product Manager | Added feature orchestrator-discord-commands (Orchestrator Discord Commands). New Discord command surface — separated from the REQ-overwrite bug fix per user directive. 5 new user stories (US-01 through US-05, feature-scoped). 34 requirements added across 6 domains: OI (Orchestrator Identity, 7 reqs: REQ-OI-01 through REQ-OI-07), CP (Command Parsing, 5 reqs: REQ-CP-01 through REQ-CP-05), CB (Create Backlog, 6 reqs: REQ-CB-01 through REQ-CB-06), HP (Help, 2 reqs: REQ-HP-01/02), AZ (Authorization, 3 reqs: REQ-AZ-01 through REQ-AZ-03), ER (Error Reporting, 6 reqs: REQ-ER-01 through REQ-ER-06), plus 5 non-functional (REQ-NF-01 through REQ-NF-05). Parent: REQ-017. Explicitly does NOT contain any `start review REQ` command (tracked separately in fix-req-overwrite-on-start). REQ at docs/backlog/orchestrator-discord-commands/REQ-orchestrator-discord-commands.md. Total requirements: 217. |
...
## Feature: orchestrator-discord-commands — Traceability View

| User Story | Requirement | FSPEC | Priority | Phase | Status |
|---|---|---|---|---|---|
| US-05 | REQ-OI-01 | — (pending) | P0 | 1 | Draft |
| US-01, US-02, US-05 | REQ-OI-02 | — | P0 | 1 | Draft |
| US-01, US-02 | REQ-OI-03 | — | P0 | 1 | Draft |
| US-05 | REQ-OI-04 | — | P0 | 1 | Draft |
| US-05 | REQ-OI-05 | — | P0 | 1 | Draft |
| US-05 | REQ-OI-06 | — | P0 | 1 | Draft |
| US-05 | REQ-OI-07 | — | P2 | 2 | Draft |
| US-01, US-02 | REQ-CP-01 | — | P0 | 1 | Draft |
| US-01 | REQ-CP-02 | — | P0 | 1 | Draft |
| US-04 | REQ-CP-03 | — | P1 | 1 | Draft |
| US-01, US-02 | REQ-CP-04 | — | P1 | 1 | Draft |
| US-01, US-02 | REQ-CP-05 | — | P1 | 1 | Draft |
| US-01 | REQ-CB-01 | — | P0 | 1 | Draft |
| US-01 | REQ-CB-02 | — | P0 | 1 | Draft |
| US-01 | REQ-CB-03 | — | P0 | 1 | Draft |
| US-01 | REQ-CB-04 | — | P0 | 1 | Draft |
| US-01 | REQ-CB-05 | — | P0 | 1 | Draft |
| US-01 | REQ-CB-06 | — | P1 | 1 | Draft |
| US-02 | REQ-HP-01 | — | P0 | 1 | Draft |
| US-03 | REQ-HP-02 | — | P0 | 1 | Draft |
| US-03, US-05 | REQ-AZ-01 | — | P0 | 1 | Draft |
| US-03 | REQ-AZ-02 | — | P0 | 1 | Draft |
| US-03 | REQ-AZ-03 | — | P0 | 1 | Draft |
| US-01, US-02 | REQ-ER-01 | — | P0 | 1 | Draft |
| US-01 | REQ-ER-02 | — | P0 | 1 | Draft |
| US-01 | REQ-ER-03 | — | P0 | 1 | Draft |
| US-01, US-04 | REQ-ER-04 | — | P1 | 1 | Draft |
| US-01, US-02 | REQ-ER-05 | — | P0 | 1 | Draft |
| US-01 | REQ-ER-06 | — | P1 | 1 | Draft |
| US-01, US-02 | REQ-NF-01 | — | P1 | 1 | Draft |
| US-01 | REQ-NF-02 | — | P1 | 1 | Draft |
| US-01 | REQ-NF-03 | — | P0 | 1 | Draft |
| US-01, US-02, US-03 | REQ-NF-04 | — | P1 | 1 | Draft |
| US-01, US-02, US-03, US-04, US-05 | REQ-NF-05 | — | P0 | 1 | Draft |
